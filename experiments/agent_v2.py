...
def escalation_decision(customer_text, intent, evidence):
    ...
    # ------------------------------------------------------------
    # Apply the same grounding / consistency gate
    # ------------------------------------------------------------
    ...
    # V2.3 SAFETY POLICY
    #
    # Similarity alone is NOT sufficient for automatic handling.
    #
    # Only historical responses that demonstrate an actionable
    # troubleshooting or account-action pattern qualify.
    #
    # Clarifications, unknown responses, generic responses, and
    # historical escalations are routed to human support.
    # ------------------------------------------------------------

    response_type = grounding.get(
        "response_type",
        "unknown"
    )
    ...
    if response_type not in {
        ...
        return (
            True,
            "Historical evidence was similar and "
            "problem-consistent, but the historical response "
            "was not an actionable troubleshooting or "
            "account-action resolution."
        )
    ...
    return (
        False,
        "Historical evidence was sufficiently similar, "
        "problem-consistent, and contained an actionable "
        "troubleshooting or account-action resolution."
    )
