...
def assign_intent(text):
    ...
    # should never be overridden by billing/mobile keywords.
    # --------------------------------------------------------
    ...
    # Must come before I05 because "FiOS mobile app"
    # is an application-access problem, not mobile service.
    # --------------------------------------------------------
    ...
    # Installation should win when the actual request is about
    # scheduling/visiting a technician.
    ...
    # I10 / I07 interaction
    #
    # Fraud was already handled above.
    # Therefore billing words below cannot override security.
    # --------------------------------------------------------
    ...
    #
    # IMPORTANT V2.4 CHANGE:
    #
    # Connectivity outcome is checked BEFORE TV and router
    # vocabulary.
    #
    # Example:
    # "internet and cable are down"
    #
    # should be I01 rather than I04 merely because "cable"
    ...
    # --------------------------------------------------------
    # Strong outage context
    #
    # Handles compound messages where the user describes
    ...
    has_internet = contains_any(t, internet_words)
    has_tv = contains_any(t, tv_words)
    has_failure = contains_any(t, failure_words)

    # If both internet and TV/cable are explicitly failing,
    # treat it as a service outage rather than a TV-only issue.
    if has_internet and has_tv and has_failure:
        return "I01"
    ...
    # IMPORTANT V2.4 CHANGE:
    #
    # Performance symptoms are checked BEFORE router/equipment.
    #
    # Example:
    # "internet is slow and I restarted my router"
    #
    # should be I02, because the user's problem is performance.
    # --------------------------------------------------------
    ...
    # I04 — TV / CHANNEL / DVR
    #
    # Reached only after outage and internet-performance
    ...
    #
    # Reached after outage/performance because router words
    # frequently appear as part of an internet symptom.
    # --------------------------------------------------------
